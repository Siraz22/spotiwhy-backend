...
//
//		Song song1 = new Song("songid1","url1","song1","artist1",new HashSet<>());
//		Song song2 = new Song("songid2","url2","song2","artist2",new HashSet<>());
//
//		section1.getSongs_set().add(song1);
//		section1.getSongs_set().add(song2);
//		section2.getSongs_set().add(song1);
//
